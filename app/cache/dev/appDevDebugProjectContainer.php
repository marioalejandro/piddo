...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/piddo/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/piddo/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_50a18dd11cbd7649f0b468b7be24c8c4');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_50a18dd11cbd7649f0b468b7be24c8c4');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_50a18dd11cbd7649f0b468b7be24c8c4');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\xampp\\htdocs\\piddo\\src\\Piddo\\UsuarioBundle\\Entity', 1 => 'C:\\xampp\\htdocs\\piddo\\src\\Piddo\\MotorBundle\\Entity', 2 => 'C:\\xampp\\htdocs\\piddo\\src\\Piddo\\AdminBundle\\Entity', 3 => 'C:\\xampp\\htdocs\\piddo\\src\\Piddo\\TallerBundle\\Entity', 4 => 'C:\\xampp\\htdocs\\piddo\\src\\Piddo\\ClienteBundle\\Entity', 5 => 'C:\\xampp\\htdocs\\piddo\\src\\Piddo\\PresupuestoBundle\\Entity', 6 => 'C:\\xampp\\htdocs\\piddo\\src\\Piddo\\RepuestoBundle\\Entity', 7 => 'C:\\xampp\\htdocs\\piddo\\src\\Piddo\\ComponenteBundle\\Entity'));
        ...
        $f->addDriver($e, 'Piddo\\AdminBundle\\Entity');
        ...
        $f->addDriver($e, 'Piddo\\RepuestoBundle\\Entity');
        $f->addDriver($e, 'Piddo\\ComponenteBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('UsuarioBundle' => 'Piddo\\UsuarioBundle\\Entity', 'MotorBundle' => 'Piddo\\MotorBundle\\Entity', 'AdminBundle' => 'Piddo\\AdminBundle\\Entity', 'TallerBundle' => 'Piddo\\TallerBundle\\Entity', 'ClienteBundle' => 'Piddo\\ClienteBundle\\Entity', 'PresupuestoBundle' => 'Piddo\\PresupuestoBundle\\Entity', 'RepuestoBundle' => 'Piddo\\RepuestoBundle\\Entity', 'ComponenteBundle' => 'Piddo\\ComponenteBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('C:/xampp/htdocs/piddo/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/piddo/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/piddo/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/piddo/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/piddo/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/piddo/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
...
>>>>>>> 759abe588276bbfa638e25a97774eb169c35aef6
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/piddo/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/piddo/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/piddo/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/piddo/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/piddo/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp/htdocs/piddo/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/piddo/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\src\\Piddo\\UsuarioBundle/Resources/views', 'Usuario');
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\src\\Piddo\\MotorBundle/Resources/views', 'Motor');
        ...
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\src\\Piddo\\RepuestoBundle/Resources/views', 'Repuesto');
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\src\\Piddo\\RecepcionBundle/Resources/views', 'Recepcion');
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\src\\Piddo\\ComponenteBundle/Resources/views', 'Componente');
        ...
        $instance->addPath('C:\\xampp\\htdocs\\piddo\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/piddo/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/piddo/app/cache/dev/assetic/assets');
    }
...
>>>>>>> 759abe588276bbfa638e25a97774eb169c35aef6
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/piddo/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/piddo/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/piddo/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/piddo/app/logs',
            'kernel.bundles' => array(
                ...
                'RepuestoBundle' => 'Piddo\\RepuestoBundle\\RepuestoBundle',
                'RecepcionBundle' => 'Piddo\\RecepcionBundle\\RecepcionBundle',
                'ComponenteBundle' => 'Piddo\\ComponenteBundle\\ComponenteBundle',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/piddo/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/piddo/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\piddo\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/piddo/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/piddo/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/piddo/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/piddo/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/piddo/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/piddo/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/piddo/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/piddo/app/cache/dev/doctrine/orm/Proxies',
